namespace SpriteKind {
    export const Murcielago = SpriteKind.create()
    export const carne = SpriteKind.create()
}
sprites.onOverlap(SpriteKind.Player, SpriteKind.Murcielago, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    Murcielago.destroy(effects.fire, 500)
    pj.sayText("Auch", 2000, true)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.stairWest, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`level`)
    tiles.placeOnRandomTile(pj, sprites.dungeon.floorDarkDiamond)
    Murcielago = sprites.create(img`
        . . f f f . . . . . . . . f f f 
        . f f c c . . . . . . f c b b c 
        f f c c . . . . . . f c b b c . 
        f c f c . . . . . . f b c c c . 
        ...
        . . f b b b b b b c f . . . . . 
        . . . f f f f f f f . . . . . . 
        `, SpriteKind.Murcielago)
    tiles.placeOnRandomTile(Murcielago, assets.tile`myTile`)
    ...
    Murcielago.follow(pj)
    Murcielago.startEffect(effects.trail, 1000000)
    game.showLongText("Creo haber escuchado un murciélago.", DialogLayout.Center)
    tiles.placeOnRandomTile(Pollo, assets.tile`myTile`)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorClosedNorth, function (sprite, location) {
    Carne.setStayInScreen(false)
    Fantasma.setStayInScreen(false)
    Murcielago.setStayInScreen(false)
    Pollo.setStayInScreen(false)
    ...
    scene.setBackgroundImage(img`
        ...
        `)
    pj.destroy()
    pjfin = sprites.create(assets.image`cat0`, SpriteKind.Player)
    pj.setPosition(20, 40)
    game.showLongText("Por fin hemos salido, muchas gracias. ", DialogLayout.Bottom)
    if (controller.A.isPressed()) {
        game.showLongText("Presiona \"A\" para reiniciar.", DialogLayout.Bottom)
        game.reset()
    }
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.stairEast, function (sprite, location) {
    ...
    tiles.placeOnRandomTile(pj, sprites.dungeon.floorDarkDiamond)
    game.showLongText("Creo haber escuchado un fantasma", DialogLayout.Center)
    ...
    Fantasma.startEffect(effects.trail, 100000)
    Fantasma.follow(pj)
    tiles.placeOnRandomTile(Fantasma, sprites.dungeon.darkGroundCenter)
    Carne = sprites.create(img`
        . . . . . . 2 2 2 2 . . . . . . 
        . . . . 2 2 3 3 3 3 2 e . . . . 
        . . . 2 3 d 1 1 d d 3 2 e . . . 
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.carne, function (sprite, otherSprite) {
    pj.sayText("Mmm, rico.", 2000, true)
    info.changeScoreBy(100)
    tiles.placeOnRandomTile(Carne, sprites.dungeon.darkGroundCenter)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    pj.sayText("Mmm, rico.", 2000, true)
    info.changeScoreBy(100)
    tiles.placeOnRandomTile(Pollo, sprites.dungeon.darkGroundCenter)
    tiles.placeOnRandomTile(Pollo, assets.tile`myTile`)
})
sprites.onOverlap(SpriteKind.Player, SpriteKind.Enemy, function (sprite, otherSprite) {
    info.changeLifeBy(-1)
    Fantasma.destroy(effects.fire, 500)
    pj.sayText("Auch", 2000, true)
})
let pjfin: Sprite = null
let Fantasma: Sprite = null
let Carne: Sprite = null
...
scene.setBackgroundImage(img`
    ...
    dddddddddd444ddddd3ddddddddddddd4ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd44dddddddddddddddddddddddddddddddddd4ddddddddd
    `)
game.showLongText("Parece buen lugar para descansar.", DialogLayout.Bottom)
...
controller.moveSprite(pj, 100, 100)
music.bigCrash.play()
...
pj.sayText("Snif Snif, creo que es comida.", 5000, true)
